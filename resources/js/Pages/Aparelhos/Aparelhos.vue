...
onMounted(() => {
    $('#tabela-aparelhos').DataTable(
        {
            language: {
                ...
                emptyTable: "Não há nenhum aparelho cadastrado!",
                paginate: {
                    first: "Primeira",
                    previous: "Anterior",
                    next: "Próxima",
    ...
    $('select[name="tabela-aparelhos_length"]').css('padding-right', '25px');
});
</script>

<template>

    <Head title="Aparelhos" />
