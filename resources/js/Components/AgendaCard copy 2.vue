...
<template>
    <div
        ...
        <div class="bg-sky-100">{{ new Date(compromisso.dia).toLocaleDateString() }}, {{ new Date(compromisso.dia).toLocaleString('pt-BR', {weekday: 'long'}) }} - {{ compromisso.hora.substring(0, 5) }}
        </div>
