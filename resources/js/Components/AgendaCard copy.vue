...
<template>
    <div
        ...
        <div v-if="agenda.atendimentos.length > 0">
            ...
            <div>
                <!-- <span class="material-symbols-outlined text-color-inherit mx-1 cursor-pointer"
                    :title="`Editar compromisso`" @click="$emit('testeDeEditar', `${agenda.dia}`)">edit</span> -->
                    <span class="material-symbols-outlined text-color-inherit mx-1 cursor-pointer"
                ...
                <span class="material-symbols-outlined text-color-inherit mx-1 cursor-pointer"
                    title="Marcar como completado" @click="$emit('completarAgendaToda', agenda.id)">done</span>
                <span class="material-symbols-outlined text-color-inherit mx-1 cursor-pointer"
                    :title="'Marcar todos com falta'" @click="$emit('faltarAgendaToda', agenda.id)">sentiment_dissatisfied</span>
                <span class="material-symbols-outlined text-color-inherit mx-1 cursor-pointer"
